...
export function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can cancel or reschedule your session up to 24 hours before the scheduled time for a full refund. Cancellations made less than 24 hours in advance will receive a 50% refund. We understand that life happens, so please contact us if you have special circumstances.",
    },
    {
      question: "Are online sessions available?",
      answer: "Yes! All my services are available both in-person and online via video call. Online sessions are just as effective and provide the flexibility to join from anywhere. You'll receive a video call link after booking.",
    },
    {
      question: "How long is each session?",
      answer: "Session lengths vary by service: Dietetics consultations are 60 minutes, Meditation sessions are 45 minutes, and Life Coaching sessions are 90 minutes. This gives us adequate time to work through your concerns and create actionable plans.",
    },
    {
